...
class quadrupedRigClass:
    ...
    def create_skin_joint( self ):
        ...
        tempJoint_rootList = [ 'R_template_clavicle_JNT','C_template_root_JNT','C_template_neck1_JNT','L_template_clavicle_JNT','L_template_hip_JNT','R_template_hip_JNT' ] #, 'template_tail1_JNT' ]

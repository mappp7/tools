...
class ikForeLegClass:
    ...
    def createController(self):
        ...
        # create clavicle
        cmds.aimConstraint( foreLegControllerName, clavicleControllerRotZNul, mo=True, aimVector = [ -1, 0, 0 ], upVector = [ 0, 1, 0 ], worldUpType='none', skip=['x', 'y'] )#-aimVector -1 0 0 -upVector 0 1 0
        ...
        wristRollCONT = controllerShape( self.wristPivotName.replace( 'PIVOT', 'CON' ), 'cube', 'blue' )

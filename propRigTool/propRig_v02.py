...
import propRig_v02_3_2_conSet_lineWidth as LW;		reload(LW)
import propRig_v02_3_3_channelBox as CB;			reload(CB)
...
#/////////////////////////////////////////////////////////////////////    
    ...
    cmds.columnLayout (adj=1, parent = propRig_v02_Window)    
    conSet_frameLayout = cmds.frameLayout (l='Controller', collapsable=1, collapse=0, bgc=frameLayout_color)
    ...
    cmds.separator ( st = 'none' )
    cmds.text ('lineWidth : ')
    cmds.floatField ('lw', v = True, precision = 2, enterCommand = LW.control_lineWidth )

...
import propRig_createCON as CC; 	reload(CC)
...
def propRigWindow () :
    ...
    cmds.button (l='Single', h=30, backgroundColor=([0.2, .7, 0]), c='CC.create_SingleCON ()')
    cmds.separator (st='none')
    cmds.button (l='Join',h=30, backgroundColor=([0.2, .7, 0]), c='CC.create_JoinCON ()')
    ...
    cmds.button (l='Single', h=30,  backgroundColor=([1, 1, 1]), c='CC.create_SingleCON_CT ()')
    cmds.separator (st='none')
    cmds.button (l='Join',h=30, backgroundColor=([1, 1, 1]), c='CC.create_JoinCON_CT ()')
    ...
    cmds.separator (st='none', h=10)
    cmds.text ('<    subCON    >        :')
    cmds.button (l='only', h=30, bgc=[0.4, 0.4, 0.4], c='SC.sort_MC_or_SC ()')
    cmds.separator (st='none', h=5)
    cmds.button (l='several', h=30, bgc=[0.4, 0.4, 0.4], c='SC.sort_MC_or_SC ()')
    cmds.separator (st='none', h=5)
    ...
    cmds.separator( h=30)
    cmds.text (' +       MODELING    :', font='obliqueLabelFont')
    cmds.button (l='Create', h=30, backgroundColor=([0.6, 0.4, 1]), c='CC.create_rootCON ()')
    cmds.separator (st='none', h=3)
    cmds.separator (st='none', h=3)
    cmds.text (' +       GRID              :', font='obliqueLabelFont')
    cmds.button (l='Create', h=30,  backgroundColor=([1, 1, 1]), c='CC.create_rootCON_CT ()')
    cmds.separator (st='none', h=20)
    cmds.setParent ('..')

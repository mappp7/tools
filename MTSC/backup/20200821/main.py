...
class MtscTool(QtWidgets.QMainWindow):
    ...
    def initialize(self , poses, rest_pose, num_bones, iterations, mayaMesh=None, jointList=None):
        ...
        for it in range(iterations):
            ...
            print np.argmin(errs, axis=0)
            print np.argmax(errs, axis=0)
        ...
        if mode ==0 :
            if self.Weight:
                ...
                for p in range(max_iterations):
                    ...
                    bone_transforms = self.update_bone_transforms(WeightArray, self.boneTransform, self.rest_bone, poses, rest_pose ,self.mesh)

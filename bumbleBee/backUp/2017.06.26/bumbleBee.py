...
class uiMainWindow( QtWidgets.QMainWindow ):
    ...
    def connectSocket(self):
        ...
        self.ui.add_LS_for_human_BTN.clicked.connect(self.addLocalSpacetoHandSub_cmd)
    ...
    def addLocalSpacetoHandSub_cmd(self):
        if cmds.objExists('L_IK_handSub_local_NUL') == False:  
            addLocalSpacetoHandSub()
        else:
            pass

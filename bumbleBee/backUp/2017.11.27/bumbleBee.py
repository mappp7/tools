...
# biped ---------------------------------------------------------------------------------------------------
    ...
    def deleteUsedSet(self):
        pass

    def setSoftIK(self):
        tempRef = {
                   1:['L_template_upArm_JNT','L_template_foreArm_JNT','L_template_hand_JNT'],
                   2:['R_template_upArm_JNT','R_template_foreArm_JNT','R_template_hand_JNT'],
                   3:['L_template_leg_JNT','L_template_lowLeg_JNT','L_template_foot_JNT']
                   4:['R_template_leg_JNT','R_template_lowLeg_JNT','R_template_foot_JNT']
                  }
        refPos = dict()

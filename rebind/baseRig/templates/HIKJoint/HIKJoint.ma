...
//Name: HIKJoint.ma
//Last modified: Fri, Mar 18, 2016 06:34:03 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.293388391317775 13.825004685627075 35.788745944893556 ;
	setAttr ".r" -type "double3" -7.5383527296031954 14.999999999999904 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 42.493489659184014;

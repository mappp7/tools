...
def add_SS_neckOP():
    ...
    jointList = [ 'C_IK_neck1_JNT', 'C_IK_neck2_JNT', 'C_IK_neck3_JNT', 'C_IK_neck4_JNT', 'C_IK_neck5_JNT', 'C_IK_neck6_JNT', 'C_IK_head_JNT' ]
    ...
    if 'ikSplineSolver' == cmds.ikHandle( ik, solver=True, q=True ):
        ...
        # POCI set # add 2018/02/09 th
        cmds.setAttr( '%s.turnOnPercentage' % POCI, 1 )
        cmds.setAttr( '%s.parameter' % POCI, 1 )
    ...
    cmds.parentConstraint ( 'C_IK_neck1_CON', 'C_FK_neck2_NUL_NUL', mo=1 )

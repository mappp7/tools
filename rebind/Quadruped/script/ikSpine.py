...
from baseRig.util.zeroRotJoint import *
from baseRig.util.getAssetRoot import *
...
class ikSpineClass:
    ...
    def createIkSpineSet(self):
        ...
        cmds.delete ( cmds.parentConstraint ( self.spineTempJointList[1], mySpineNul1 ) )

        mySpineNul2 = cmds.group ( em=True, name='C_FKsub_spine2_NUL' )
        cmds.delete(cmds.parentConstraint( self.spineTempJointList[1], self.spineTempJointList[4], mySpineNul2 ) )

        mySpineNul3 = cmds.group ( em=True, name='C_FKsub_spine3_NUL' )
        cmds.delete(cmds.parentConstraint ( self.spineTempJointList[7], self.spineTempJointList[4], mySpineNul3 ) )

        myChestNul = cmds.group ( em=True, name='C_FKsub_chest_NUL' )
        cmds.delete(cmds.parentConstraint ( self.spineTempJointList[7], myChestNul ) )
